...
const MainHero = ({ stadt }: { stadt: string }) => {
      ...
      <div className="sm:text-center lg:text-left">
        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-5xl">
          ...
          <span className={`block text-primary xl:inline`}>
            {stadt !== null && stadt !== undefined && stadt !== ''
              ? `in ${stadt}`
              : mainHero.subtitle}
          </span>
        </h1>
        ...
        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
          ...
          <div className="mt-3 sm:mt-0 sm:ml-3">
            <a
              ...
              className={`w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md border-primary text-secondary bg-background hover:bg-background hover:text-primary md:py-4 md:text-lg md:px-10`}
            >
